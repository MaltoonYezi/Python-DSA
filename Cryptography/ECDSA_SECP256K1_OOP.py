...
#x and y coordinates of R
R = randomNumberK * G
r = R.x.num

#Inverse of randomNumberK
k_inv = pow(randomNumberK, N-2, N)

s = (hashZ+r*privateKeyE) * k_inv % N

pubKey = privateKeyE*G

#Test case 1
print("The point:", pubKey)
print("Uncompressed public key:", "\n04", str(pubKey.x.num), str(pubKey.y.num))
